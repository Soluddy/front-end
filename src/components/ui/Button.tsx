...
export default function Button({
    ...
    const commonClasses = clsx(
        "inline-flex items-center justify-center gap-2 rounded-full text-sm font-bold transition-colors cursor-pointer",
        iconOnly ? "p-2 w-[42px] h-[42px]" : "px-5 py-2",
        !hideBorder ? "border-2 border-[#333333]" : "border-none",
        bgColor,
        textColor,
        hoverColor,
        height,
